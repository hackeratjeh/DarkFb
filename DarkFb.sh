#bin/bash/Hacker_Boss
clear
echo
figlet -f slant " HACKER_BOSS"
sleep 2
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "[●]          GUNAKAN DENGAN BAIK               [●]" | lolcat
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "[●] • Author   : Hacker_Boss                   [●]" | lolcat
echo "[●] • Github   : https://github.com/hackeratjeh[●]" | lolcat
echo "[●] • Youtube  : HackerBoss                    [●]" | lolcat
echo "[●] • Facebook : Unull                         [●]" | lolcat
echo "[●] • Group    : TERMUX°CYBER°TEAM             [●]" | lolcat
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "[●]     •JANGAN LUPA SUBSCRIBE Hacker Boss•    [●]" | lolcat
echo "[●]■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■[●]" | lolcat
echo "
┏━━━━━┫{menu dark fb}┣━━━━━┓
┃
┠──[00] untuk instal bahan agar work ✔
┃
┠──[01] Dark 1.6 ✔
┃
┠──[02] Dark 1.7 [-FREE-] ✔
...
┠──[15] MR.Rendy-Dark
┠
┗────[99] exit ✘" | lolcat -a -d 10
echo
read -p "root@Hacker_Boss# " bro
